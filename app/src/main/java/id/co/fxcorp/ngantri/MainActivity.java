...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, OnMapReadyCallback, AppService.Callback {
    ...
    private void setupAutoStart() {
        try {
            if (Prefs.getAutoStartAsking(this)) {
                return;
            }
            Prefs.setAutoStartAsking(this);
    ...
    private void buildAlertMessageNoGps() {
        ...
        builder.setMessage("Mohon aktifkan GPS agar kami dapat mengetahui lokasi Anda.")
                .setCancelable(false)
